...
\begin{itemize}
\item
	\ressubheading{École Polytechnique}{Palaiseau, France}{License, Mathematiques et Informatique (GPA: 4.2/4.0)}{Septembre 2019 - Present}
	\begin{itemize}
...
\item
	...
	\begin{itemize}
		\resitem{Concentrations: Mathematiques, Physique, Chimie, et Biologie}
	\end{itemize}
...
\item
	...
	\begin{itemize}
		\resitem{En tant que CTO, je dirige l'équipe de développement chez Anemone.}
		\resitem{Nous construisons un réseau socioprofessionnel adaptée aux besoins de l'ensemble des industries culturelles.}
	\end{itemize}
\item
	...
	\end{itemize}
\item
	\ressubheading{Department Informatique, École Polytechnique (DIX)}{Palaiseau, France}{Stagiaire en recherche}{Juin 2021 - Decembre 2021}
	\begin{itemize}
...
\begin{itemize}
\item
	\ressubheading{Nuit de l'IA Hackathon}{}{Organisé par Binet AI et l'accélérateur de start-ups X-UP de l'Ecole Polytechnique}{Septembre 2019}
	\begin{itemize}
